...
class Zend_Log
{
    ...
    {
        /** Custom addition by CustomerParadigm
         * @author CustomerParadigm <watchdog@customerparadigm.com>
         */
        if ($priority < 6)
        {
            if (strstr($message, "Notice:")) $priority = 5;
            if (strstr($message, "Warning:")) $priority = 4;
            Mage::dispatchEvent("CP_DOG_ERROR", array("message" => $message, "level" => $priority ));
        }
        // sanity checks
